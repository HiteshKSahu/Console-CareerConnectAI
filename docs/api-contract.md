# CareerConnect AI - REST API Contract
...
## 5. AI Career Assistant (Ollama Integration)

### 5.1 Ask AI Assistant
- **Method**: `POST`
- **Path**: `/api/chat`
- **Request Body**:
```json
...
```
  - `503 Service Unavailable`: Ollama service down or unreachable. Core placement APIs continue functioning.
