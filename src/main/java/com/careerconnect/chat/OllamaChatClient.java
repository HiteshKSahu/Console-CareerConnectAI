...
/**
 * Adapter that translates our ChatClient interface calls into
 * Ollama's HTTP API format. All the Ollama-specific JSON wrangling
 * stays in this class so the rest of the app doesn't have to care.
 */
@Component
public class OllamaChatClient implements ChatClient {
    ...
    public OllamaChatClient(
        ...
        // TODO: could use WebClient for non-blocking calls in the future
    ...
    public String chat(String systemPrompt, String userMessage) {
        ...
        // build the request body in the format Ollama expects
        ...
        try {
            ...
            // this happens when Ollama is not running or connection times out
